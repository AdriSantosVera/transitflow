  ...
  return (
    <section className="widget-card p-6">
      <div className="mb-5 flex items-center justify-between gap-4">
        <div>
          <h3 className="text-lg font-semibold text-slate-950">Notas recientes</h3>
          <p className="mt-1 text-sm text-slate-400">Ideas y recordatorios de viaje</p>
        </div>
      ...
      <div className="space-y-3">
        {notes.map((note) => (
          <article key={note.id} className="rounded-2xl bg-slate-50 px-4 py-3">
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-indigo-600">
